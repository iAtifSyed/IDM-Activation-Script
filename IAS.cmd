...
echo:
echo:
echo:                This script is NOT working with latest IDM. Always Choose to "Freeze Trial"    
...
echo:            ___________________________________________________
echo:         
call :_color2 %_White% "             " %_Green% "Enter a menu option in the Keyboard [1,2,3,4,5,0] by Atif Shah"
choice /C:123450 /N
set _erl=%errorlevel%
